...
<form action="display.php">
  ...
  <label for="vehicle1"> <h4>There is no specific format that a contract must follow. Generally it will include some terms, either expressed or implied, that will form the basis of the agreement. These terms may outline contract conditions or contract warranties.
...
special conditions</h4></label><br>
 <br>
